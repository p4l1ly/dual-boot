...
BOOT_PART="/dev/nvme0n1p4"      # Linux Boot Partition
RECOVERY_PART="/dev/nvme0n1p8"  # Windows Recovery (990MB, moved)
ROOT_PART="/dev/nvme0n1p5"      # Linux Root Partition (LUKS encrypted)
SHARED_PART="/dev/nvme0n1p6"    # Shared Storage Partition (LUKS encrypted)
SWAP_PART="/dev/nvme0n1p7"      # Linux Swap Partition (LUKS encrypted)
HOSTNAME="dell-xps"
USERNAME=""
